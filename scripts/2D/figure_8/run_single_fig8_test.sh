...
# echo "--- Running Single Test: Figure 8 (2x alpha) ---"
...
# # Physical parameters for the "2x_alpha" case
# # Baseline alpha is 0.6, so 2x is 1.2
# ALPHA_VALUE=1.2
# # d_ext and d_axn are at their baseline values
# D_EXT_VALUE=1.5
# D_AXN_VALUE=3.0

# # --- Step 3: Define the output location ---
# OUTPUT_DIR="results/2D_tests/figure_8/2x_alpha/"
