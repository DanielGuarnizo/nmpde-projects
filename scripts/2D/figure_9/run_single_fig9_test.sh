...
# # --- Step 3: Define common simulation parameters ---
# EXECUTABLE="./build/neuro_disease_2D"
# MESH_FILE="meshes/new_slice_generated.msh" # Or your newest mesh file
# TOTAL_TIME=48.0
# TIME_STEP=0.24
# POLY_DEGREE=1
# C_0_VALUE=0.2
...
#     "isotropic")       fiber_type=2 ;; # Fiber type doesn't matter for isotropic, but we must provide one
#     *) echo "Error: Invalid FIBER_MODEL_NAME '$FIBER_MODEL_NAME'"; exit 1 ;;
# esac

# # Special handling for the isotropic case (d_axn = 0)
...
# OUTPUT_DIR="results/2D_tests/single_test_fig9/${DISEASE_NAME}_${FIBER_MODEL_NAME}/"
...
# n=$(nproc)
# echo "NUMBER OF PROCESSORS FIND BY MPI ARE ${n}"
